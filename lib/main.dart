...
import 'package:canteiro/colors.dart';
...
import 'package:canteiro/ui/extended_launch_screen.dart';
...
void mainDelegate() {
  ...
  runApp(
    MultiBlocProvider(
        providers: [
          BlocProvider(
            create: (context)=> AppBloc(AppBlocState()),
          ),
          BlocProvider(
            create: (context)=> PushNotificationsBloc(PushNotificationsBlocState()),
          ),
        ],
        child: MyApp(),
    ),
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
          primarySwatch: CanteiroColors.primarySwatch,
      ...
      home: FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.active ||
            ...
            return LaunchScreenPage();
          }
          return ExtendedLaunchScreen();
        },
      ),
    );
  }
